...
5. Definir `CRON_SECRET`, `SUPABASE_SERVICE_ROLE_KEY` y dejar `web/vercel.json` activo para que `/api/automation/dispatch` procese etapas y followups cada minuto desde cron.
